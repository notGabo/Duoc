...
function eesy_init_require() {
    ...
    eesyRequire( ['jquery-private', 'sessionInfo', 'engine_core'], function($, sessionInfo, engineCore) {
        ...
        //  Load the CSS
        //
        eesy_load_css(var_style_path +
            "/proactiveresources/style.css" +
        ...
        eesy_load_css(var_dashboard_url +
            ...
            "?v=" + var_eesy_build + "&styleChecksum=" + var_eesy_style_checksum + "&__=" + location.host);

        eesy_load_css(var_style_path +
            "/override-proactive.css" +
            "?styleChecksum=" + var_eesy_style_checksum + "&__=" + location.host);

        eesy_load_css(var_dashboard_url +
            "/static/css/support-center-theme-defaults.min.css" +
            "?_" + var_eesy_build + "&__=" + location.host);
...
function eesy_initUserValues(onUserValuesInited) {
    var_show_tab = (!!var_key) && (var_show_tab_initial || var_user_map.isShowTab);
