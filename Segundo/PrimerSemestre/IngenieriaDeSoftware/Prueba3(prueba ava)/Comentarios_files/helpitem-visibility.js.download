...
eesy.define([
    ...
    'view-controller', 'json!helpitem-reset-stamps'
], function ($, sessionInfo, language, hipa, viewController, helpitemResetStamps) {
    ...
    function helpitemVisibilityKey(hid) {
        return [
            hid,
            var_user_map.reset_views_stamp,
            helpitemResetStamps[hid],
