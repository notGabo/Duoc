...
eesy.define(['jquery-private', 'sessionInfo', 'engine-state', 'presentation', 'helpitem-loader',
    'utils', 'helpitem-visibility', 'view-controller', var_uefMode ? 'uef-messages-handlers' : 'helpitem-handlers'
    ...
    function handleQueuedContextLinks() {
        ...
        viewController.allItems().forEach(function (controllerItem) {
            if (!helpitemInArray(items, controllerItem) && controllerItem.itemType !== viewController.ITEM_TYPE.HINT) {
